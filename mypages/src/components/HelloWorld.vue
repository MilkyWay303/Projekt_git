...
export default defineComponent({
  ...
  setup() {
    return {
      value: ref(null),
      options: ref([
        { name: 'Polski', language: 'JavaScript' },
        { name: 'Angielski', language: 'Ruby' },
        { name: 'Niemiecki', language: 'Ruby' },
        { name: 'Japoński', language: 'PHP'},
        { name: 'Hiszpański', language: 'Elixir' }
      ])
    }
  }
}
...
<template>
  ...
  <div class="relative w-full">
      <header class="mx-10 z-30 fixed top-0 left-0 right-0 py-5">
          <nav class="flex gap-x-1 justify-around ">
            
              <a class="text-white" href="/">
                  <svg width="124" height="34" viewBox="0 0 124 34" class="">
                      <g fill="currentColor">
                          <path
              ...
              <div class="GuzikMed1 flex gap-x-12 text-white text-lg ">
                  <RouterLink to="/Pobierz">Pobierz</RouterLink>
                  <RouterLink to="/Nitro">Nitro</RouterLink>
                  <RouterLink to="/Odkryj">Odkryj</RouterLink>
                  <RouterLink to="/Bezpieczeństwo">Bezpieczeństwo</RouterLink>
                  <RouterLink to="/Wsparcie">Wsparcie</RouterLink>
                  <RouterLink to="/Blog">Blog</RouterLink>
                  <RouterLink to="/Kariera">Kariera</RouterLink>
              </div>
              <div class="">
                  <a class="ButMed2 bg-white rounded-3xl px-5 p-2 text-black" href="//discord.com/login">Zaloguj się</a>
              </div>
          </nav>
      </header>
  </div>
  <main>
        <section class="section relative">
            <div class="obrazki1 w-full">
                <img class="obrasek2" alt="Góry" src="../assets/Diskoła3.svg">
            </div>
            <div class="obrazki1">
                <div class="obrazki2">
                    <img id="img1" class="ObrMed obrasek 2xl:h-80" alt="But" src="../assets/Diskoła2.svg">
                    <img class="ObrMed img2 obrasek 2xl:h-80" alt="Lada" src="../assets/Diskoła.svg">
                </div>
            </div>
            <div class="container1 ">
                <h1 class="Yes Napis1 wyobras uppercase">
                    Wyobraź sobie <br>
                    miejsce...</h1> 
                <p class="Napis2 NapisMed1 ">...gdzie możesz należeć do szkolnego klubu, grupy osób grających w gry czy globalnej
                    społeczności artystów. Gdzie możesz
                    po prostu spędzać czas z garstką znajomych. Miejsce, które ułatwia codzienne rozmowy i częstsze
                    spędzanie czasu razem.</p>
            </div>
            <div class="Przyciski flex m-auto justify-center gap-x-6 h-16 ">
                <button class="button1 buttonWindows text-black bg-white rounded-full px-7 text-xl h-full border-white z-30 items-center">Pobierz dla systemu windows</button>
                <button class="button2 buttonWindows bg-black text-white px-7 rounded-full text-xl items-center z-30">Otwórz Discorda w przeglądarce</button>
            </div>
        </section>
        <section class="container1 mediaContainer bg-white ">
            <div class="flex gap-x-10 tag ">
                <img class=""
                    alt="Stylized image of a Discord server with multiple channels for studying, games, cooking, and pet photos."
                    src="../assets/Diskoła4.svg" />
                <div class="flex flex-col gap-y-10 justify-center">
                    <h2 class="text-5xl font-bold text-left text-black">Stwórz miejsce dostępne na zaproszenie, gdzie czujesz się u siebie</h2>
                    <div class="NapisMed2 text-xl text-left text-black">Serwery Discorda zorganizowane są w kanały
                        tematyczne, na których można współpracować, udostępniać materiały lub po prostu pogadać bez
                        zapychania
                        czatu grupowego.
                    </div>
                </div>
        ...
        <div class="bg-[#f6f6f6]">
            <section class="container1 py-36 ">
                <div class="flex gap-x-10 m-auto tag">
                    <div class="flex flex-col justify-center gap-y-10 w-1/2 pl-72 ">
                        <h2 class="text-5xl font-bold text-left text-black">Łatwe spędzanie<br>
                            czasu</h2>
                        <div class="NapisMed2 text-xl text-left text-black">Gdy masz czas, rozsiądź się wygodnie na<br> 
                            kanale głosowym. Znajomi na Twoim serwerze<br> 
                            widzą, że tu jesteś, i mogą wpaść pogadać<br>
                            bez dzwonienia.<br>
                        </div>
                    </div>
                    <img class="block w-1/2" 
                        alt="Stylized image showing friends hanging out in multiple voice channels." 
                        src="../assets/Diskoła5.svg">
                </div>
            </section>
        </div>
        ...
        <section class="container1 mediaContainer bg-white">
            <div class="flex gap-x-10 tag">
                <img class=""
                    ...
                    src="../assets/Diskoła6.svg" />
                <div class="flex flex-col gap-y-10 justify-center">
                    <h2 class="text-5xl font-bold text-left text-black">Od garstki osób do całego fandomu</h2>
                    <div class="NapisMed2 text-xl text-left text-black">Zgromadź dowolną społeczność dzięki narzędziom
                        moderowania i personalizacji dostępu użytkowników. Daj członkom społeczności specjalne moce, uruchom
        ...
        <div class="bg-[#f6f6f6]">
            <section class="container1 pt-36 pb-2">
                <div class="flex flex-col items-center gap-x-10 m-auto tag">
                   <div class="flex flex-col justify-center gap-y-10 absolute">
                   <h2 class="text-5xl font-bold relative text-black">Godna zaufania technologia, by pozostać w kontakcie</h2>
                      <div class="NapisMed2 text-xl relative text-black">Komunikacja głosowa i wideo o niskich opóźnieniach sprawia, że czujecie się, jakbyście byli w tym samym pomieszczeniu. Pomachaj do kamery, oglądaj streamy z gier znajomych lub zbierzcie się na sesję wspólnego rysowania na współdzielonym ekranie.
                      </div>
                    </div>
                      
            <img class="mt-40 block w-full" 
            alt="Stylized image fing friends video talking with each other on desktop and mobile." 
            src="../assets/Diskoła7.svg">
        ...
        <div class="bg-[#f6f6f6]">
            <section class="container1 pt-10 pb-14">
                <div class="">
                    <div class="flex flex-col gap-y-10 ">
                        <h2 class=" NapisMed3 text-3xl font-bold relative text-black">Chcesz zacząć swoją podróż?</h2>
                        <div class="flex m-auto justify-center gap-x-6 h-16 ">
                            <button class="ButMed1 button1 bg-[#5865f2] text-white rounded-full px-7 text-xl h-full border-white z-30 items-center">Pobierz dla systemu windows</button>
                            </div>
                    </div>
                </div>
            </section>
        ...
        <div class="text-white bg-[#23272A]">

        <section class="container1">
            <div class="flex flex-col gap-y-10 " role="navigation">
                <div class="flex justify-between gap-x-4">
                    <div class="">
                            <div class="">
                                <div class="">
                                <div class="">
                                    <div tabindex="0" class="" role="button">
                                        <div class="">
                                            <!-- <img class="flag-sHwnaY" src="/assets/894cceea2dd5b523936930d1d7e333c5.png" alt=""> -->
                                        ...
                                        <!-- <img class="" src="/assets/779a770c34fcb823a598a7277301adaf.svg" alt="Open Locale Picker"> -->
                                    </div>
                                </div>
                            </div>
                            <div class="flex mt-6 items-center">
                                <a class="" href="https://twitter.com/discord" title="Discord on Twitter">
                                ...
                                <a class="ml-7" href="https://www.instagram.com/discord/" title="Discord on Instagram"><svg width="24"
                                        height="24" viewBox="0 0 24 24" class="">
                                        <g fill="currentColor">
                                ...
                                <a class="ml-7" href="https://www.facebook.com/discord/" title="Discord on Facebook"><svg width="24"
                                ...
                                <a class="ml-7" href="https://www.youtube.com/discord/" title="Discord on YouTube"><svg width="24"
                                        height="24" viewBox="0 0 24 24" class="socialIcon-38NB2e">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <a class="ml-7 link-1naFFL linkDefault-3q74_X socialLink-1h9CDw" href="https://www.tiktok.com/@discord" title="Discord on TikTok">
                                    <svg width="24" height="24" viewBox="0 0 24 24" class="socialIcon-38NB2e">
                                        <path fill="currentColor" d="M17.836 6.009A4.794 4.794 0 0 1 15.658 2h-3.439l-.005 13.78a2.892 2.892 0 0 1-2.885 2.782 2.893 2.893 0 0 1-2.89-2.89 2.894 2.894 0 0 1 2.89-2.89c.298 0 .583.048.853.133v-3.51a6.308 6.308 0 0 0-.853-.062A6.336 6.336 0 0 0 3 15.672a6.324 6.324 0 0 0 2.702 5.181A6.29 6.29 0 0 0 9.329 22a6.336 6.336 0 0 0 6.329-6.329V8.683c1.348.968 3 1.539 4.784 1.539V6.783c-.96 0-1.855-.285-2.605-.775v.001Z">
                    ...
                    <div class="GuzikMed1 text-left">
                        <h5 class="BlueHeather">Produkt</h5><a
                            class="mt-4" href="/download"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Pobierz</span></a><a
                            class="mt-2" href="/nitro"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Nitro</span></a><a
                            class="mt-2" href="https://discordstatus.com"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Status</span></a>
                    </div>
                    <div class=" GuzikMed1 text-left">
                        <h5 class="BlueHeather text-2H5FnP textSmall-Rm6-Ys colHeader-3LmkbR">Firma</h5><a
                            class="mt-4" href="/company"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">O nas</span></a><a
                            class="mt-2" href="/jobs"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Praca</span></a><a
                            class="mt-2" href="/branding"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Materiały promocyjne</span></a><a
                            class="mt-2" href="/newsroom"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Informacje prasowe</span></a>
                    </div>
                    <div class=" GuzikMed1 text-left">
                        <h5 class="BlueHeather text-2H5FnP textSmall-Rm6-Ys colHeader-3LmkbR">Zasoby</h5><a
                            class="mt-4" href="/college"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Szkoła wyższa</span></a><a
                            class="mt-2" href="//support.discord.com/hc/en-us"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Wsparcie</span></a><a
                            class="mt-2" href="/safetycenter"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Bezpieczeństwo</span></a><a
                            class="mt-2" href="/blog"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Blog</span></a><a
                            class="mt-2" href="//feedback.discord.com"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Informacje zwrotne</span></a><a
                            class="mt-2" href="/build"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Build</span></a><a
                            class="mt-2" href="/streamkit"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">StreamKit</span></a><a
                            class="mt-2" href="/creators"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Creators</span></a><a
                            class="mt-2" href="/community"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Community</span></a>
                    </div>
                    <div class="GuzikMed1 text-left ">
                        <h5 class="BlueHeather text-2H5FnP textSmall-Rm6-Ys colHeader-3LmkbR">Polityki</h5>
                        <a class="mt-4" href="/terms">
                            <span class="text-2H5FnP textSmall-Rm6-Ys">
                                Warunki
                            </span>
                        </a>
                        <a class="mt-2" href="/privacy">
                            <span class="text-2H5FnP textSmall-Rm6-Ys">Prywatność</span>
                        </a><a class="mt-2" href="/"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Ustawienia ciasteczek</span></a><a
                            class="mt-2" href="/guidelines"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Wytyczne</span></a><a
                            class="mt-2" href="/acknowledgements"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Podziękowania</span></a><a
                            class="mt-2" href="/licenses"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Licencje</span></a><a
                            class="mt-2" href="/moderation"><span
                                class="text-2H5FnP textSmall-Rm6-Ys">Moderacja</span></a>
                    </div>
                </div>
                    ...
                    <div class="">
                        ...
                        <div class="flex justify-between mt-8">
                            ...
                            <a class="block" aria-label="Home"
                                href="/"><svg width="124" height="34" viewBox="0 0 124 34" class="">
                                    <g fill="currentColor">
                                        <path
                                            d="M26.0015 6.9529C24.0021 6.03845 21.8787 5.37198 19.6623 5C19.3833 5.48048 19.0733 6.13144 18.8563 6.64292C16.4989 6.30193 14.1585 6.30193 11.8336 6.64292C11.6166 6.13144 11.2911 5.48048 11.0276 5C8.79575 5.37198 6.67235 6.03845 4.6869 6.9529C0.672601 12.8736 -0.41235 18.6548 0.130124 24.3585C2.79599 26.2959 5.36889 27.4739 7.89682 28.2489C8.51679 27.4119 9.07477 26.5129 9.55525 25.5675C8.64079 25.2265 7.77283 24.808 6.93587 24.312C7.15286 24.1571 7.36986 23.9866 7.57135 23.8161C12.6241 26.1255 18.0969 26.1255 23.0876 23.8161C23.3046 23.9866 23.5061 24.1571 23.7231 24.312C22.8861 24.808 22.0182 25.2265 21.1037 25.5675C21.5842 26.5129 22.1422 27.4119 22.7621 28.2489C25.2885 27.4739 27.8769 26.2959 30.5288 24.3585C31.1952 17.7559 29.4733 12.0212 26.0015 6.9529ZM10.2527 20.8402C8.73376 20.8402 7.49382 19.4608 7.49382 17.7714C7.49382 16.082 8.70276 14.7025 10.2527 14.7025C11.7871 14.7025 13.0425 16.082 13.0115 17.7714C13.0115 19.4608 11.7871 20.8402 10.2527 20.8402ZM20.4373 20.8402C18.9183 20.8402 17.6768 19.4608 17.6768 17.7714C17.6768 16.082 18.8873 14.7025 20.4373 14.7025C21.9717 14.7025 23.2271 16.082 23.1961 17.7714C23.1961 19.4608 21.9872 20.8402 20.4373 20.8402Z">
                                        </path>
                            ...
                            <a class="block" href="//discord.com/register">
                                <button class="ButMed2 button1 bg-[#5865f2] rounded-full p-2 px-5 text-base h-full border-black z-30 items-center">Zarejestruj się</button>
                            </a>
                        </div>
                    </div>
                </div>
